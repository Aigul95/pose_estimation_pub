...
class TemporalModelBase(nn.Module):
    ...
    def __init__(
        self, num_joints_in, in_features, num_joints_out, filter_widths, causal, dropout, channels
    ):
        super().__init__()
...
class TemporalModel(TemporalModelBase):
    ...
    def __init__(
        ...
        """
        super().__init__(
            num_joints_in, in_features, num_joints_out, filter_widths, causal, dropout, channels
        )
